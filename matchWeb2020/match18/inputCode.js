!function (_, __) {
    var ___ = "undefined" == typeof global ? window : global, v__ = [[___, null, null, this, arguments]], V__ = String.fromCharCode, y__ = decodeURIComponent, u__ = ReferenceError, U__ = Object.keys, _v_ = parseFloat, _V_ = parseInt, _y_ = Math.pow, _u_ = RegExp, _U_ = ___.BigInt, __v = 1, __V = [], __y = [], __u = Vu_(48, 58) + Vu_(97, 123), __U = Vu_(65, 91), v_ = "[" + __U + "]*[" + __u + "]", V_ = __u + __U, y_ = /[0-9a-f]{2}/g, u_ = "%$&", U_ = "$", _v = " is not defined", _V = "null", _y = "number", _u = "object", _U = "0", vv_ = "g", vV_ = "", vy_ = "arguments";
    ...
    function Vy_(_, __) {
        if (3 == __ || 6 == __ || 28 == __ || 15 == __ || 11 == __ || 13 == __ || 30 == __ || 41 == __) {
            ...
            var ___ = function (_, __) {
                ...
                if (3 == _ && (___ = _y_(U__, y__)), 6 == _ && (___ = v_U(U__)), 28 == _ && (___ = null), 15 == _ && (___ = v_U(U__)), 11 == _ && (___ = _v_(__v(U__, y__))), 13 == _ && (___ = !!_V_(V__(_y_(U__, y__)))), 30 == _ && (___ = _U_(__v(U__, y__))), 41 == _) {
                    var __y = __v(U__, y__), __u = __y.slice(0, v_y(__y, U_)), __U = __y.slice(v_y(__y, U_) + 1);
                    ___ = _u_(__u, __U)
                }
                return [___, y__, u__]
            }(__, _.slice(__v, 10));
        ...
        for (var v__ = V_U(_, __v)[0], y__ = [], u__ = {}; v_v(v__);) {
            ...
            if (3 != U__ && 6 != U__ && 28 != U__ && 15 != U__ && 11 != U__ && 13 != U__ && 30 != U__ && 41 != U__) {
                ...
                vu_(y__, V_v(v__)), v__ = v__.slice(_y_[1])
            } else {
                var __u = V_v(v__);
                vu_(y__, __u[0]), v__ = v__.slice(__v + __u[1])
            }
        }
    ...
    function V_V(_) {
        var __ = 0, ___ = _.match(v_)[0], v__ = ___.slice(0, -1), V__ = ___[v_v(___) - 1];
        __ += v_V(__u, V__);
        for (var y__ = 0, u__ = v_v(v__) - 1; u__ >= 0; u__--) __ += v_V(__U, v__[u__]) * _y_(v_v(__U), y__) * v_v(__u), y__ += 1;
        return [__, v_v(___)]
    }
    ...
    !function (_) {
        ...
        function __V(_, v__, u__, __y, __u) {
            ...
            if (43 == __U) u_.map(function (__) {
                ...
                if (36 == __U) if (Vv_(u_[0], 29)) _v = __V(_, u_[1]), u_[0][29].map(function (___, v__) {
                    _u_(_)[0][__(___, 6)] = _v[v__]
                }); else {
                    var U_ = __(u_[0], 6), _v = __V(_, u_[1]);
                    ...
                    if (27 == __U) {
                        vv_ = __(u_[0], 3);
                        var v_y = __V(_, u_[1]), v_U = __V(_, u_[2]);
                    ...
                    if (46 == __U) {
                        ...
                        if (4 == __U) (_U = u__) && V__(_U[9], 1); else if (24 == __U) (_U = u__) && V__(_U[35], 1); else {
                            if (18 == __U) {
                                var Vu_ = {};
                                return u_.map(function (__) {
                                    var ___ = __V(_, __), v__ = ___[0], V__ = ___[1];
                                    Vu_[v__] = V__
                                }), Vu_
                            }
                            ...
                            if (31 == __U) {
                                ...
                                if (2 == __U) {
                                    var V_U = __V(_, u_[0]), yv_ = __V(_, u_[1]), yV_ = u_[2];
                                ...
                                if (0 == __U) {
                                    ...
                                    if (39 == __U) {
                                        ...
                                        if (19 == __U) {
                                            U_ = __(___(u_), 6), _v = u_[v_v(u_) - 2];
                                            var yu_ = u_.slice(0, v_v(u_) - 2), yU_ = _U__(_, U_, _v, yu_);
                                            _u_(_)[0][U_] = yU_
                                        } else {
                                            ...
                                            if (37 == __U) {
                                                var y_v = __V(_, ___(u_)), ____ = u_.slice(0, v_v(u_) - 1).map(function (__) {
                                                    return __V(_, __)
                                                });
                                            ...
                                            if (40 == __U) {
                                                _U = u__, VU_ = __V(_, u_[0]);
                                                var v___ = u_.slice(1), V___ = !1;
                                                for (vu_(_U[9], 0), vu_(_U[35], 0), Vy_ = 0; Vy_ < v_v(v___); Vy_++) if (___(_U[35])) V__(_U[35], 0); else {
                                                    var y___ = __V(_, v___[Vy_], VU_), u___ = y___[0], U___ = y___[1];
                                                    if (VU_ === u___ && (V___ = !0), V___ && (Vu_ = __V(_, U___, _U)), ___(_U[9])) break;
                                                    if (_U[0]) return Vu_
                                                }
                                                vU_(_U[9]), vU_(_U[35])
                                            } else {
                                                if (47 == __U) return [u___ = Vv_(u_[0], 6) && __(u_[0], 6) == _V ? u__ : __V(_, u_[0]), u_[1]];
                                                if (44 == __U) debugger; else if (49 == __U) {
                                                    ...
                                                    }), _U = {9: [], 35: [], 0: 0}, Vy_ = 0; Vy_ < v_v(VV_); Vy_++) if (Vu_ = __V(_, VV_[Vy_], _U), _U[0]) return Vu_
                                                } else {
                                                    if (32 == __U) {
                                                    ...
                                                    if (48 == __U) {
                                                        var _V__, _y__ = !1, _u__ = (____ = u_.slice(0, -1).map(function (__) {
                                                            if (!Vv_(__, 45)) return __V(_, __);
                                                            _V__ = __V(_, __), _y__ = !0
                                                        }), typeof u__ == _u ? u__ : {});
                                                        return _u__[24] = 1, ____ = _y__ ? ____.slice(0, v_v(____) - 1).concat(_V__) : ____, __V(_, ___(u_), 0, 0, _u__).apply(void 0, y__(____))
                                                    }
                                                }
                                            }
                                        }
            ...
            function _U__(_, ___, v__, V__) {
                return function y__() {
                    ...
                    var _v_ = _u_(u__), _V_ = (_u_(_), {9: [], 35: [], 0: 0});
                    return _v_[1].map(function (_, ___) {
                        if (Vv_(_, 6)) {
                            var v__ = __(_, 6);
                            _v_[0][v__] = _v_[4][___]
                        } else Vv_(_, [12]) && (v__ = __(__(_[12], 6), 6), _v_[0][v__] = U__(_v_[4]).map(function (_) {
                            return _v_[4][_]
                        }).slice(___))
                    }), __V(u__, _v_[2], _V_)
                }
        ...
        var __, ___, v__, V__ = V_U(_, 0), y__ = V__[0], u__ = V__[1];
        for (y__ = function (_) {
            var __ = V_V((_ = _.match(_u_(v_, vv_))).slice(0, 1)[0])[0], ___ = _.slice(1, -1), v__ = [];
            ___.map(function (_) {
            ...
            var U__ = (___ = VV_((__ = y__).slice(0, 1)), v__ = VV_(__.slice(1, 1 + ___)), [__.slice(1 + ___, 1 + ___ + v__), 1 + ___ + v__]), _v_ = U__[1];
            vu_(__V, U__[0]), y__ = y__.slice(_v_)
        }
        return _.slice(u__)
    }(__)))
