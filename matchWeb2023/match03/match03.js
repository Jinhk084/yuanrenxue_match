...
SM3.prototype.reset = function() {
    const Jinhk = [1937770108, 1983173321, 385893078, 3666375988, 2701930684, 353449901, 3816598093, 4008382286];
    this.reg[0] = Jinhk[0];
    this.reg[1] = Jinhk[1];
    this.reg[2] = Jinhk[2];
    this.reg[3] = Jinhk[3];
...
SM3.prototype._t = function(j) {
    // 2044544281 和 2081922442 两种情况
	if (0 <= j && j < 16) {
		return 2044544281; // 原本: `return 0x79cc4519;`
	} else if (16 <= j && j < 64) {
		return 2081922442; // 原本: `return 0x7a879d8a;`
	} else {
...
// let result = sm3Digest('17152280521405')
// console.log(result)
// if (result==='7f695d86e9e7edb97320179bbb7715046b4a20651984f8a6b50ed7e35138e0bf'){
// 	console.log('!!!!!!!!!!!!!! 成功 !!!!!!!!!!!!!!')
// }else {
// 	console.log('失败');
// }
