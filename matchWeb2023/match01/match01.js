/*
* 搜索: window document navigator location global 关键词定位监测点,对照浏览器实际的执行结果,修改运行的分支
*
*
*
* */
...
(function () {
    ...
    2: [function (a, b, c) {
        call = function (page) {
            ...
            // {
            //     "page": "1",
            //     "token": "84da378e9f2dc482d2012cef3fb423fc",
            //     "now": 1715023613961
            // }

            if (j.token === '84da378e9f2dc482d2012cef3fb423fc') {
                console.log('环境校验-成功!');
            } else {
                console.log('环境校验-失败!');
            }
            ...
            //         $('.page-message').eq(parseInt(d) - 1).addClass('active');
            //     },
            //     'complete': function () {
            //     },
            //     'error': function () {
    ...
    3: [function (a, b, c) {
        (function (d, e, f) {
            ...
            (function () {
                ...
                // var s = typeof global !== 'undefined' ? [0, 27, 54, 8, 16, 1, 2, 4, 128, 32, 64] : [0, 1, 2, 4, 128, 27, 54, 8, 16, 32, 64];
                            ...
                            if (B < x) {
                                ...
                                if (!(B % x)) {
                                    ...
                                    if (x > 6 && B % x == 4) {
                                        ...
                                        delete window;
                                        window = 0;
                                        u = window ? i[u >>> 26] << 24 | i[u >>> 16 & 255] << 16 | i[u >>> 8 & 255] << 8 | i[u & 255] : i[u >>> 22] << 24 | i[u >>> 16 & 255] << 16 | i[u >>> 8 & 255] << 8 | i[u & 255];
                                        */
                                        u = window ? i[u >>> 26] << 24 | i[u >>> 16 & 255] << 16 | i[u >>> 8 & 255] << 8 | i[u & 255] : i[u >>> 22] << 24 | i[u >>> 16 & 255] << 16 | i[u >>> 8 & 255] << 8 | i[u & 255];
                                    }
                                }
                ...
                (function (e) {
                    ...
                    var w = g.BlockCipher = p.extend({
                        ...
                        'reset': function () {
                            ...
                            if (this._mode && this._mode.__creator == F) {
                                ...
                                this._mode = F.call(I, this, H && H.words);
                    ...
                    var z = y.OpenSSL = {
                        'stringify': function (F) {
                            ...
                            var I = F.salt;
                            if (I) {
                                G = i.create([1398893684, 1701076831]).concat(I).concat(H);
                            } else {
                                G = H;
                            }
                            return G.toString(m);
            ...
            (function () {
                (function (e, f) {
                    ...
                    var e = e || function (f, g) {
                        ...
                        if (!h && typeof window !== 'undefined' && window.msCrypto) {
                            h = window.msCrypto;
                        }
                        if (!h && typeof d !== 'undefined' && d.crypto) {
                            h = d.crypto;
                        }
                        ...
                        var m = l.Base = function () {
                            return {
                                'extend': function (w) {
                                    ...
                                    if (!x.hasOwnProperty('init') || this.init === x.init) {
                                        x.init = function () {
    ...
    7: [function (a, b, c) {
        (function (d, e) {
            ...
            (function () {
                ...
                var h = e.enc;
                var i = h.Base64url = {
                    'stringify': function (k, l = true) {
                        var m = k.words;
                        var n = k.sigBytes;
                        var o = l ? this._safe_map : this._map;
                        k.clamp();
                        var p = [];
                        for (var q = 0; q < n; q += 3) {
                    ...
                    'parse': function (k, l = true) {
                        var m = k.length;
                        var n = l ? this._safe_map : this._map;
    ...
    12: [function (a, b, c) {
        (function (d, e, f) {
            if (typeof c === 'object') {
                ...
                if (typeof define === 'function' && define.amd) {
                    define(['./core', './x64-core', './lib-typedarrays', './enc-utf16', './enc-base64', './enc-base64url', './md5', './sha1', './sha256', './sha224', './sha512', './sha384', './sha3', './ripemd160', './hmac', './pbkdf2', './evpkdf', './cipher-core', './mode-cfb', './mode-ctr', './mode-ctr-gladman', './mode-ofb', './mode-ecb', './pad-ansix923', './pad-iso10126', './pad-iso97971', './pad-zeropadding', './pad-nopadding', './format-hex', './aes', './tripledes', './rc4', './rabbit', './rabbit-legacy'], e);
                } else {
            ...
            (function (e) {
                ...
                var l = j.MD5 = i.extend({
                    '_doReset': function () {
                        try {
                            RCON[0][0][0];
                            this._hash = new h.init([1732583426, 4023233408, 2562383102, 271733878]);
                        } catch (q) {
                            if (typeof document === 'object') {
                                this._hash = new h.init([1732584193, 4023233408, 2562383102, 271733878]);
                            } else {
                                this._hash = new h.init([1732583426, 4023233408, 2562383102, 50484342]);
                            }
                        }
                    },
                    '_doProcessBlock': function (q, r) {
                        ...
                        if (typeof location === 'object' && typeof location.href === 'string' && location.href.indexOf('topic') !== -1) {
                            Q = p(Q, R, S, P, L, 18, k[59]);
                        } else {
                            Q = p(Q, R, S, P, L, 9, k[59]);
                        }
            ...
            (function () {
                ...
                var k = i.SHA1 = h.extend({
                    ...
                    '_doFinalize': function () {
                        ...
                        var o = l.sigBytes * 8;
                        m[o >>> 5] |= 128 << 24 - o % 32;
                        m[(o + 64 >>> 9 << 4) + 14] = Math.floor(n / 4294967296);
                        m[(o + 64 >>> 9 << 4) + 15] = n;
            ...
            (function (e) {
                ...
                var n = j.SHA256 = i.extend({
                    ...
                    '_doFinalize': function () {
                        ...
                        var r = o.sigBytes * 8;
                        p[r >>> 5] |= 128 << 24 - r % 32;
                        p[(r + 64 >>> 9 << 4) + 14] = e.floor(q / 4294967296);
                        p[(r + 64 >>> 9 << 4) + 15] = q;
                        o.sigBytes = p.length * 4;
                        this._process();
                        return this._hash;
                    },
                    'clone': function () {
                        var o = i.clone.call(this);
                        o._hash = this._hash.clone();
                        return o;
                    }
                });
            ...
            (function () {
                ...
                var r = i.TripleDES = h.extend({
                    '_doReset': function () {
                        ...
                        var u = t.slice(0, 2);
                        var v = t.length < 4 ? t.slice(0, 2) : t.slice(2, 4);
                        var w = t.length < 6 ? t.slice(0, 2) : t.slice(4, 6);
